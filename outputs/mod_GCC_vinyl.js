//
// mod_GCC_vinyl.js
//   fab modules GCC vinylcutter output
//
// Neil Gershenfeld 
...
define(['require',
   ...
   function mod_load_handler() {
      globals.output = "GCC_vinyl"
      ui.ui_prompt("process?")
      var controls = findEl("mod_output_controls")
      controls.innerHTML = mod_gcc_vinyl_controls_tpl()
   ...
   function mod_GCC_vinyl_path(path) {
      globals.type = ".gcc"
   ...
   return {
      ...
      mod_GCC_vinyl_path: mod_GCC_vinyl_path
   }
