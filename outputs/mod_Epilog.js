...
function mod_Epilog_path(path) {
   ...
   var power = parseFloat(document.getElementById("mod_power").value)
   var speed = parseFloat(document.getElementById("mod_speed").value)
   var rate = parseFloat(document.getElementById("mod_rate").value)
   var ox = parseFloat(document.getElementById("mod_x_origin").value)/25.4
   var oy = parseFloat(document.getElementById("mod_y_origin").value)/25.4
   ...
   var str = "%-12345X@PJL JOB NAME="+document.mod.input_basename+"\r\n"
   str += "E@PJL ENTER LANGUAGE=PCL\r\n"
   if (document.getElementById("mod_autofocus").checked)
      //
