...
function mod_G_path(path) {
   document.mod.type = ".nc"
   var dx = document.mod.width/document.mod.dpi
   var nx = document.mod.width
   var cut_speed = 60*parseFloat(document.getElementById("mod_cut_speed").value)/25.4
   var plunge_speed = 60*parseFloat(document.getElementById("mod_plunge_speed").value)/25.4
   var jog_height = parseFloat(document.getElementById("mod_jog_height").value)/25.4
   var spindle_speed = parseFloat(document.getElementById("mod_spindle_speed").value)
   var tool = document.getElementById("mod_tool").value
   var scale = dx/(nx-1)
   var xoffset = 0
   var yoffset = 0
   var zoffset = 0
   ...
   str += "S"+spindle_speed+"\n" // spindle speed
   if (document.getElementById("mod_coolant_on").checked)
      str += "M08\n" // coolant on
