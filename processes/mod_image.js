...
function mod_image_halftone(img,diameter,spot_size,spot_min,spot_spacing_h,spot_spacing_v,spot_points,spot_fill) {
   img.get = mod_image_get
   var dx = Math.floor(document.mod.dpi*spot_size*(1+spot_spacing_h/100)/(2*25.4))
   var dy = Math.floor(document.mod.dpi*spot_size*(1+spot_spacing_v/100)/(2*25.4))
   var r = Math.floor(document.mod.dpi*(spot_size/2)/25.4)
   var dr = Math.floor(document.mod.dpi*(diameter/2)/25.4)
