...
function mod_path_show_gl(path) {
   ...
   canvas.onmouseup = function(evt) {
      ...
      if (document.mod.button == 0) {
         document.mod.dx = document.mod.dx + 2*(evt.clientX - document.mod.xdown)/
            (canvas.offsetWidth*document.mod.s)
         document.mod.dy = document.mod.dy-2*(evt.clientY - document.mod.ydown)/
            (canvas.offsetWidth*document.mod.s)
         draw(document.mod.s,document.mod.dx,document.mod.dy,document.mod.rx,document.mod.rz)
         }
      else if (document.mod.button == 2) {
         document.mod.rz = document.mod.rz + Math.PI*(evt.clientX - document.mod.xdown)/
            canvas.offsetWidth
         document.mod.rx = document.mod.rx - Math.PI*(evt.clientY - document.mod.ydown)/
            canvas.offsetHeight
         }
      }
   canvas.onmousemove = function(evt) {
      if (document.mod.down == false)
         return
      if (document.mod.button == 0) {
         var dx = document.mod.dx + 2*(evt.clientX - document.mod.xdown)/
            (canvas.offsetWidth*document.mod.s)
         var dy = document.mod.dy-2*(evt.clientY - document.mod.ydown)/
            (canvas.offsetWidth*document.mod.s)
         draw(document.mod.s,dx,dy,document.mod.rx,document.mod.rz)
         }
      else if (document.mod.button == 2) {
         var rz = document.mod.rz + Math.PI*(evt.clientX - document.mod.xdown)/
            canvas.offsetWidth
         var rx = document.mod.rx - Math.PI*(evt.clientY - document.mod.ydown)/
            canvas.offsetWidth
         draw(document.mod.s,document.mod.dx,document.mod.dy,rx,rz)
         }
      }
